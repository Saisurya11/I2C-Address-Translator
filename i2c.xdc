...
## - rename the used ports (in each line, after get_ports) according to the top level signal names in the project
 ...
 set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets scl_out_OBUF[0]] 

 set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ready_OBUF[0]]
...
set_property PACKAGE_PIN B13 [get_ports {en[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {en[0]}]
#Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {en[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {en[1]}]
#Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports {en[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {en[2]}]
#Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
set_property PACKAGE_PIN E17 [get_ports {ready[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ready[0]}]
#Bank = 15, Pin name = IO_0_15,								Sch name = JA7
set_property PACKAGE_PIN G13 [get_ports {ready[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ready[1]}]
#Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = JA8
set_property PACKAGE_PIN C17 [get_ports {ready[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ready[2]}]
#Bank = 15, Pin name = IO_L21N_T3_A17_15,					Sch name = JA9
set_property PACKAGE_PIN D18 [get_ports {sda_in}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sda_in}]
#Bank = 15, Pin name = IO_L21P_T3_DQS_15,					Sch name = JA10
set_property PACKAGE_PIN E18 [get_ports {scl_in}]					
...
set_property PACKAGE_PIN G14 [get_ports {translation_byte[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {translation_byte[0]}]
#Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
set_property PACKAGE_PIN P15 [get_ports {translation_byte[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {translation_byte[1]}]
#Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
set_property PACKAGE_PIN V11 [get_ports {translation_byte[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {translation_byte[2]}]
#Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = JB4
set_property PACKAGE_PIN V15 [get_ports {translation_byte[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {translation_byte[3]}]
#Bank = 15, Pin name = IO_25_15,							Sch name = JB7
set_property PACKAGE_PIN K16 [get_ports {translation_byte[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {translation_byte[4]}]
#Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = JB8
set_property PACKAGE_PIN R16 [get_ports {translation_byte[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {translation_byte[5]}]
#Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = JB9
set_property PACKAGE_PIN T9 [get_ports {translation_byte[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {translation_byte[6]}]
...
set_property PACKAGE_PIN K2 [get_ports {scl_out[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {scl_out[0]}]
#Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
set_property PACKAGE_PIN E7 [get_ports {scl_out[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {scl_out[1]}]
#Bank = 35, Pin name = IO_L22P_T3_35,						Sch name = JC3
set_property PACKAGE_PIN J3 [get_ports {scl_out[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {scl_out[2]}]
...
set_property PACKAGE_PIN H4 [get_ports {sda_out[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sda_out[0]}]
#Bank = 35, Pin name = IO_L17P_T2_35,						Sch name = JD2
set_property PACKAGE_PIN H1 [get_ports {sda_out[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sda_out[1]}]
#Bank = 35, Pin name = IO_L17N_T2_35,						Sch name = JD3
set_property PACKAGE_PIN G1 [get_ports {sda_out[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sda_out[2]}]
